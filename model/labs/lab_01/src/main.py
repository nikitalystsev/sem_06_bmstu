...
def main() -> None:
    ...
    print(task_02.get_x_u_by_analyt(0.3))
    print(task_02.get_x_u_by_picard1(0.3))
    print(task_02.get_x_u_by_picard2(0.3))
    print(task_02.get_x_u_by_picard3(0.3))
    print(task_02.get_x_u_by_picard4(0.3))
    # print(task_02.get_x_u_by_picard5(0.3))
